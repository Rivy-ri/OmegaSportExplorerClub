...
namespace OmegaSportExplorerClub.src.DatabaseReaders.ReadersCollection
{
    ...
    {
        /// <summary>
        /// Method that return list of strings base on selected entity 
        /// </summary>
        /// <param name="type">name of entity</param>
        /// <returns>List of strings base on selected entity</returns>
        /// <exception cref="Exception">when list is empty</exception>
