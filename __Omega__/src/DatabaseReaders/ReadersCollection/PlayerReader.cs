...
namespace OmegaSportExplorerClub.src.DatabaseReaders.ReadersCollection
{
    ...
    {
        /// <summary>
        /// Method will get players list from Player entity whits are in selected training group
        /// </summary>
        /// <param name="groupName">Name of group witch players we want to show</param>
        /// <returns></returns>
        ...
        /// <summary>
        /// Method will write all known players in to data grid view for selected group
        /// </summary>
        /// <param name="view">place where retrieved data will be displayed</param>
        /// <param name="groupName"> for which training group we want to get data</param>
