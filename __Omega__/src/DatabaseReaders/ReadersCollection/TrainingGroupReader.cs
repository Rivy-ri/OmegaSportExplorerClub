...
namespace OmegaSportExplorerClub.src.DatabaseReaders.ReadersCollection
{
    ...
    {
        /// <summary>
        /// Method will get information about all training groups from database and return them in form of list  
        /// </summary>
        /// <returns></returns>
        ...
        /// <summary>
        /// Method from will wrote into data grid view data from database
        /// </summary>
        /// <param name="view">Data grid where information will be written</param>
