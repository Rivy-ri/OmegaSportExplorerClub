...
namespace OmegaSportExplorerClub.src.DatabaseReaders.ReadersCollection
{
    ...
    {
        /// <summary>
        /// Method will get all know match records from database for selected team
        /// </summary>
        /// <param name="teamName"></param>
        /// <returns> List of match of selected team</returns>
        ...
        /// <summary>
        /// Method will write all known match record in to data grid view for selected team
        /// </summary>
        /// <param name="view">place where will be data written</param>
        /// <param name="input">name of team for which we want to get data </param>
