namespace OmegaSportExplorerClub
{
    partial class LogIn
    {
        ...
        private void InitializeComponent()
        {
            ...
            ResetPasswordText = new MaterialSkin.Controls.MaterialLabel();
            ...
            materialCard1.Controls.Add(ResetPasswordText);
            ...
            // ResetPasswordText
            // 
            ResetPasswordText.AutoSize = true;
            ResetPasswordText.Cursor = Cursors.Hand;
            ResetPasswordText.Depth = 0;
            ResetPasswordText.FlatStyle = FlatStyle.Popup;
            ResetPasswordText.Font = new Font("Roboto", 14F, FontStyle.Bold, GraphicsUnit.Pixel);
            ResetPasswordText.FontType = MaterialSkin.MaterialSkinManager.fontType.Button;
            ResetPasswordText.HighEmphasis = true;
            ResetPasswordText.Location = new Point(102, 473);
            ResetPasswordText.MouseState = MaterialSkin.MouseState.HOVER;
            ResetPasswordText.Name = "ResetPasswordText";
            ResetPasswordText.Size = new Size(162, 17);
            ResetPasswordText.TabIndex = 7;
            ResetPasswordText.Text = "Forgot password? reset it";
            ResetPasswordText.UseAccent = true;
            ResetPasswordText.Click += ResetPasswordText_Click;
            // 
            // ChBRememberMe
            // 
            ...
            L_registration.Location = new Point(80, 442);
        ...
        private MaterialSkin.Controls.MaterialLabel ResetPasswordText;
    }
}